...
<div class="container" style="margin: 10% auto">
    <div class="ff" style="text-align: end;  margin: 2%;">
        <a href="{{ route('main') }}">
            <button type="submit">Ana menu</button>
        </a>
    </div>
    <form action="{{ route('addSellAction') }}" method="post">
        @csrf
        {{--        {{ dd(Request()->id) }}--}}{{--{{ Session::get('userID')}}--}}

        <input type="hidden" name="userID" value="{{ Request()->id != null ? Request()->id : Session::get('userID') }}">
        <div class="form-group row">
            <label for="fee" class="col-sm-2 col-form-label">Fee <span> * </span></label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="fee" placeholder="fee" name="fee" required>
            </div>
        </div>


        <div class="form-group row">
            <label for="bargain" class="col-sm-2 col-form-label">Bargain</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="takhfif" name="bargain">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="note" id="note" cols="90" rows="3" ></textarea>
            </div>
        </div>
